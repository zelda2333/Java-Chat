...
public class ServerOperationXML 
{
	public static void main(String[] args) {
		ServerOperationXML xml = new ServerOperationXML();
		xml.AddXmlNode("473034728","473034128nd", "牛迪", "最喜欢的歌手是谁？", "周杰伦", "03", "Keep Looking,Don't Settle!");
	}
	...
	public void ChangeXmlDocument(String index, String key, String value)
	{
		try 
		{
			...
			Document document = saxReader.read("system/Document/ServerUserInformation.xml");
			//获取节点
			...
			Writer out;
			try {
				 out = new FileWriter("system/Document/ServerUserInformation.xml");
	...
	public String ReadNode(String index, String key)
	{
		...
		try 
		{
			...
			for (Element element : elementsList)
			{
				if (element.attribute("ID").getValue().equals(index))
				{
					temp = element.attribute(key).getValue();
	...
	public void AddXmlNode(String ID, String password, String name,String question, 
	...
	public void CreateXmlDocument(String ID, String password, String name, 
			String portraitNum, String autograph,String question, String answer)
	{
		//创建一个xml文档
